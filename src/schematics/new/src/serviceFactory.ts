...
import { wordpressReactService } from "./services/wordpressReactService/wordpressReactService";
...
// prettier-ignore
export const services = [NodeService, Php7Service, NginxService, postgresService , wordpressService , mysqlService , mongoService , redisService, LaravelService , nextService , craService, wordpressReactService, /*ADDNEWSERVICE*/];
// prettier-ignore-end
